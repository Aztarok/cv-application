...
export default function Example({ setBirthday }) {
    ...
    function handleYearChange(event) {
        ...
        const currentMonthName = format(firstDayCurrentMonth, "MMM");
        const newDate = parse(
    ...
    return (
        <div className="pt-4 bg-white flex-1 md:w-[400px] lg:w-[35vw] max-w-[400px] 2xl:w-[25vw] rounded-lg">
            <div className="max-w-md px-4 mx-auto sm:px-7 md:max-w-4xl md:px-6 flex justify-center">
                        ...
                        <div className="flex items-center">
                            <h2 className="flex-auto font-semibold text-gray-900">
                                ...
                                <select
                                    ...
                                    className="ml-2 p-1 border border-gray-300 rounded text-white"
                                >
